        ...
        <div class="main">
            <div class="main__flex">
                <div class="main__products">
                    <ProductCard v-for="product in searchAndSortHandler" :product="product" :key="product.id"/>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            async fetchProducts() {
                const prodResp = await AuthAPI.get('users/get_user')

                this.products = prodResp.data.favouriteProducts
            }
        },
